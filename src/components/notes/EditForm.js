...
import useInput from '../costumehook/useInput'
        ...
        <div className="section">
            ...
            <form onSubmit={handleSubmit} className="white">
                ...
                <div className="input-field">
                    ...
                    <label className="active" forhtml="note_title">Note Title </label>
                </div>

                <div className="input-field">
                    <textarea id="note_content" className="materialize-textarea" {...bindContent}></textarea>
                    <label className="active" forhtml="note_content">Note Content</label>
                </div>
